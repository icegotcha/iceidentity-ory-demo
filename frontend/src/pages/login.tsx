...
const Home = () => {
  return (
    <Layout title='Login'>
      <Image src={LoginIllust} width={300} className='mb-8' alt='Login Illustration' />
      <Title>Login</Title>
      <form className='mt-8'>
        <div className='mb-4'>
        ...
        <div className='mb-10'>
          <input
            type='submit'
            value='Sign In'
            className='w-full rounded-md border border-primary py-3 px-5  bg-primary text-base text-white cursor-pointer hover:bg-primary-dark transition'
          />
        </div>
      </form>
      <p className='text-base mb-6 text-[#adadad]'>Or Connect With</p>
